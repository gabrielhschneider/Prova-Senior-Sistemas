...
uses
  Classes, System.TypInfo, SysUtils;
...
{Metodo ToString, criado para representar corretamente o objeto na tela como solicitado}
function TTroco.ToString: string;
var
  aNomeClasse : String;
begin
  aNomeClasse := TTroco.ClassName;
  Result := aNomeClasse + ' ' + GetEnumName(TypeInfo(TCedula), Ord(FTipo)) +
